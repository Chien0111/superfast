...
const ContentAcademic = () => {
  return (
    <div className=" p-5">
      ...
      <p className="text-ct-primary-05 font-bold text-mb my-6">
        Academic success
      </p>
      <p className="text-ct-neutral-04 font-normal">
        In our decade-long legacy of nurturing the ‘unique potential’ of every
        child, we have shaped, in metros and suburbs alike, a new cult of
        schooling for toddlers
      </p>
