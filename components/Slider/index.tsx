...
const SampleNextArrow = (props: arrowProps) => {
    ...
    return (
        <span
            className="flex absolute right-0 bg-ct-neutral-01 h-min rounded-full -ml-10 z-50 justify-center items-center"
            onClick={onClick}
        >
...
const SamplePrevArrow = (props: arrowProps) => {
    ...
    return (
        <span
            className="flex absolute left-0 h-min rounded-full -mr-10 z-50 justify-center items-center"
            onClick={onClick}
        >
